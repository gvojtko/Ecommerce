...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{ asset('tools/bootstrap.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('site/custom/style.css') }}">
  ...
  <body>
    ...
    @include('partials.navminhaconta')
    ...
    @include('partials.footerdefault')
